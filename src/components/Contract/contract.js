...
var {constants} = require('../SonicXWrap');
...
var contract = (function (module) {
  ...
  var Utils = {
    ...
    linkBytecode: function (bytecode, links) {
      Object.keys(links).forEach(function (library_name) {
        ...
        // var address = SonicXWrap.address2HexString(library_address);
  ...
  Contract._static_methods = {
    ...
    initSonicXWeb: function (options) {
      if (!sonicxWrap) {
    ...
    setProvider: function (provider) {
      ...
      // sonicxWrap.setHttpProvider(provider.host);
    ...
    new: function () {
      ...
      return new Promise(function (accept, reject) {
        ...
        sonicxWrap._deployContract(tx_params, _callback);
    ...
    at: function (address) {
      ...
      throw new Error('The construct contractArtifacts.at(address) is not currently supported by SonicXBox. It will be in the future. Stay in touch.')
      ...
      contract.then = function (fn) {
        return new Promise(function () {
          ...
          return new Promise(function (accept, reject) {
            sonicxWrap._getContract(address, function (err, contractAddress) {
    ...
    call: function (methodName, ...args) {
      ...
      return new Promise(function (accept, reject) {
        ...
        sonicxWrap.triggerContract(option, _callback);
      })
    },
    deployed: function () {
      var self = this;
      return new Promise(function (accept, reject) {
        ...
        SonicXWrap().trx.getContract(self.address)
          .then(res => {
  ...
  Contract._properties = {
    ...
    events: function () {
      ...
      abi.forEach(function (item) {
        ...
        var topic = SonicXWrap().sha3(signature);
