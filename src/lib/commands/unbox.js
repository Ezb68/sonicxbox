...
function normalizeURL(url) {
  url = url || "https://github.com/sonicxbox-boxes/bare-box";
  ...
  if (url.indexOf("/") == -1) { // repo name only
    ...
    return "https://github.com/sonicxbox-boxes/" + url;
  }
...
var command = {
  command: 'unbox',
  description: 'Download a sonicxbox Box, a pre-built sonicxbox project',
  builder: {},
